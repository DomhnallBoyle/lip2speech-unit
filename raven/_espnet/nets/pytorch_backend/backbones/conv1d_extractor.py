...
import torch
import numpy as np
from _espnet.nets.pytorch_backend.backbones.modules.resnet1d import ResNet1D
from _espnet.nets.pytorch_backend.backbones.modules.resnet1d import BasicBlock1D
...
class Conv1dResNet(torch.nn.Module):
    ...
    def __init__(
        self, relu_type="swish", a_upsample_ratio=1, gamma_zero=False, gamma_init=0.1
    ):
        """__init__.
