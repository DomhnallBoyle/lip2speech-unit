...
from _espnet.nets.scorer_interface import ScorerInterface
from _espnet.utils.dynamic_import import dynamic_import
from _espnet.utils.fill_missing_args import fill_missing_args
...
class LMInterface(ScorerInterface):
    ...
    def build(cls, n_vocab: int, **kwargs):
        ...
        from _espnet.bin.lm_train import get_parser
